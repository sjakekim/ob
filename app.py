...
from flask_jwt_extended import (
    ...
    #  jwt_refresh_token_required, ==> jwt_required로 통합
    #https://flask-jwt-extended.readthedocs.io/en/stable/v4_upgrade_guide.html 참조
 )

# from flask import Flask, render_template, request, jsonify, Blueprint, make_response, current_app as app
# from flask_jwt_extended import (
#     JWTManager,
#     create_access_token,
...
app = Flask(__name__)
app.config['JWT_SECRET_KEY'] = "THINKer_in"
